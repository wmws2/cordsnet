...
class step3cordsnetparametric(nn.Module):
    ...
    def rnn(self,area,r,img,alpha):
        ...
        r[area]  = (1-alpha)*r[area] + alpha*self.prelu(self.area_conv[area](r[area]) + self.conv_bias[area] + self.area_area[area](areainput))
        return r[area]